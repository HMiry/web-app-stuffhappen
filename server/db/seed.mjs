...
const seedDatabase = () => {
  return new Promise((resolve, reject) => {
    ...
    const workCards = [
      { title: "Accidentally sent nude photo to entire company", severity: 100.0, image: "/images/work1.png" },
      { title: "Deleted entire company database by mistake", severity: 97.5, image: "/images/work2.png" },
      { title: "Sleeping with boss's spouse exposed", severity: 95.0, image: "/images/work3.png" },
      { title: "Arrested at work for tax fraud", severity: 92.5, image: "/images/work4.png" },
      { title: "Company secrets accidentally sent to competitor", severity: 90.0, image: "/images/work5.png" },
      { title: "Stealing from company petty cash discovered", severity: 87.5, image: "/images/work6.png" },
      { title: "Threw up on CEO during board meeting", severity: 85.0, image: "/images/work7.png" },
      { title: "Drinking alcohol during important presentation", severity: 82.5, image: "/images/work8.png" },
      { title: "Adult content discovered on work computer", severity: 80.0, image: "/images/work9.png" },
      { title: "Physical fight with supervisor in lobby", severity: 77.5, image: "/images/work10.png" },
      { title: "Accidentally started office fire", severity: 75.0, image: "/images/work11.png" },
      { title: "Sexual harassment lawsuit filed against you", severity: 72.5, image: "/images/work12.png" },
      { title: "Fell down stairs and broke both legs", severity: 70.0, image: "/images/work13.png" },
      { title: "Pants fell down during important client meeting", severity: 67.5, image: "/images/work14.png" },
      { title: "Food poisoning from company cafeteria lunch", severity: 65.0, image: "/images/work15.png" },
      { title: "Elevator trapped you inside for 8 hours", severity: 62.5, image: "/images/work16.png" },
      { title: "Locked out of building completely naked", severity: 60.0, image: "/images/work17.png" },
      { title: "Insulted boss accidentally in group email", severity: 57.5, image: "/images/work18.png" },
      { title: "Bathroom stall door jammed during emergency", severity: 55.0, image: "/images/work19.png" },
      { title: "Spilled hot coffee on major client", severity: 52.5, image: "/images/work20.png" },
      { title: "Resume lies exposed during interview", severity: 50.0, image: "/images/work21.png" },
      { title: "Snored loudly during important meeting", severity: 47.5, image: "/images/work22.png" },
      { title: "Vomited on desk from stomach flu", severity: 45.0, image: "/images/work23.png" },
      { title: "Expensive office equipment broken accidentally", severity: 42.5, image: "/images/work24.png" },
      { title: "Lost and missed crucial client presentation", severity: 40.0, image: "/images/work25.png" },
      { title: "Forgot to wear pants to work", severity: 37.5, image: "/images/work26.png" },
      { title: "Revolving door trapped you embarrassingly", severity: 35.0, image: "/images/work27.png" },
      { title: "Angry email sent to boss by mistake", severity: 32.5, image: "/images/work28.png" },
      { title: "Nose picking witnessed during video call", severity: 30.0, image: "/images/work29.png" },
      { title: "Tripped and fell in front of everyone", severity: 27.5, image: "/images/work30.png" },
      { title: "Bad-mouthing boss overheard by colleagues", severity: 25.0, image: "/images/work31.png" },
      { title: "Pajamas worn to office accidentally", severity: 22.5, image: "/images/work32.png" },
      { title: "Hiccups disrupted entire presentation", severity: 20.0, image: "/images/work33.png" },
      { title: "Boss's name completely forgotten at meeting", severity: 17.5, image: "/images/work34.png" },
      { title: "Smelly fish lunch offended coworkers", severity: 15.0, image: "/images/work35.png" },
      { title: "Called boss 'mom' during conversation", severity: 12.5, image: "/images/work36.png" },
      { title: "Paper cut during handshake with client", severity: 10.0, image: "/images/work37.png" },
      { title: "Loud sneeze interrupted silent moment", severity: 7.5, image: "/images/work38.png" },
      { title: "Pen dropped during job interview", severity: 5.0, image: "/images/work39.png" },
      { title: "Personal phone use during work hours", severity: 2.5, image: "/images/work40.png" },
      { title: "Email resignation sent accidentally", severity: 100.0, image: "/images/work41.png" },
      { title: "Chronic lateness finally addressed", severity: 1.0, image: "/images/work42.png" },
      { title: "Important client's name forgotten completely", severity: 3.5, image: "/images/work43.png" },
      { title: "Sleeping at desk during work hours", severity: 6.0, image: "/images/work44.png" },
      { title: "Two different shoes worn to work", severity: 8.5, image: "/images/work45.png" },
      { title: "Office bathroom door stuck for hours", severity: 11.0, image: "/images/work46.png" },
      { title: "Lunch spilled on important documents", severity: 13.5, image: "/images/work47.png" },
      { title: "Company car used for personal date", severity: 16.0, image: "/images/work48.png" },
      { title: "Boss's favorite coffee mug broken", severity: 18.5, image: "/images/work49.png" },
      { title: "Personal calls made during work time", severity: 21.0, image: "/images/work50.png" }
    ];
